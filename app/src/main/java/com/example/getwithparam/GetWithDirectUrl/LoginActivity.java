package com.example.getwithparam.GetWithDirectUrl;
...
import com.example.getwithparam.databinding.ActivityDirectLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    ActivityDirectLoginBinding mBinding;
    LoginActivity ctx = LoginActivity.this;
    GeneralAPIInterface loginApiInterface;
    String BASE_URL = "http://api.cssolution.in/";
    String URL = "http://api.cssolution.in/login_service.php?email=gkr.2910@gmail.com&password=123456";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinding = DataBindingUtil.setContentView(ctx, R.layout.activity_direct_login);
...
//                    Toast.makeText(ctx, "Please enter password", Toast.LENGTH_SHORT).show();
    ...
    private void GetResponse() {
        ...
        if(isInternetConnected()) {
            ...
            Call<GeneralModel> call2 = loginApiInterface.getStatus2(URL);
